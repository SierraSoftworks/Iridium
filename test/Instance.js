...
describe("Instance", function () {
    ...
    describe("methods", function () {
        it("should expose save()", function () {
            chai.expect(core.Test.wrap({ id: '1', answer: 2 }).save).to.exist.and.be.a('function');
        });
        it("should expose update()", function () {
            chai.expect(core.Test.wrap({ id: '1', answer: 2 }).update).to.exist.and.be.a('function');
        });
        it("should expose refresh()", function () {
            chai.expect(core.Test.wrap({ id: '1', answer: 2 }).refresh).to.exist.and.be.a('function');
        });
        it("should expose delete()", function () {
            chai.expect(core.Test.wrap({ id: '1', answer: 2 }).delete).to.exist.and.be.a('function');
        });
        it("should expose remove()", function () {
            chai.expect(core.Test.wrap({ id: '1', answer: 2 }).remove).to.exist.and.be.a('function');
        });
        it("should override toJSON()", function () {
            chai.expect(core.Test.wrap({ id: '1', answer: 2 }).toJSON()).to.eql({ id: '1', answer: 2 });
        });
        it("should override toString()", function () {
            chai.expect(core.Test.wrap({ id: '1', answer: 2 }).toString()).to.eql(JSON.stringify({ id: '1', answer: 2 }, null, 2));
        });
    });
    describe("properties", function () {
        it("should expose document", function () {
            chai.expect(core.Test.wrap({ id: '1', answer: 2 }).document).to.eql({ id: '1', answer: 2 });
        });
    });
