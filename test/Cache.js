...
describe("Cache", function () {
    ...
    describe("integration", function () {
        ...
        var model = new Iridium.Model(core, Instance, 'test', { id: false }, {
        ...
        describe("should be populated", function () {
            ...
            it("when a single document is retrieved", function () {
                return model.get().then(function (instance) { return chai.expect(core.cache.get(instance.id)).to.eventually.exist; });
            });
            it("when an instance is modified", function () {
                return model.get().then(function (instance) {
                    core.cache = new Iridium.MemoryCache();
                    return instance.save();
                }).then(function (instance) { return chai.expect(core.cache.get(instance.id)).to.eventually.exist; });
            });
        });
        ...
        describe("should be cleaned", function () {
            ...
            it("when an instance is removed", function () {
                return model.get().then(function (instance) { return instance.remove(); }).then(function (instance) { return chai.expect(core.cache.get(instance.id)).to.eventually.be.undefined; });
            });
            it("when remove is called with compatible conditions", function () {
                return model.get().then(function (instance) {
                    return model.remove({ id: instance.id }).then(function () { return instance; });
                }).then(function (instance) { return chai.expect(core.cache.get(instance.id)).to.eventually.be.undefined; });
            });
        });
    });
});
