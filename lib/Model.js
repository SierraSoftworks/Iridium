...
var Model = (function () {
    ...
    Model.prototype.findOne = function () {
        ...
        return Promise.resolve().bind(this).then(function () {
            ...
            if (!document)
                return null;
            return _this.handlers.documentReceived(conditions, document, function (document, isNew, isPartial) { return _this.helpers.wrapDocument(document, isNew, isPartial); }, options);
        }).nodeify(callback);
    };
    ...
    Model.prototype.insert = function (objs) {
        ...
        return Promise.resolve().then(function () {
            ...
            return _this.handlers.documentReceived(null, inserted, function (document, isNew, isPartial) { return _this.helpers.wrapDocument(document, isNew, isPartial); }, { cache: options.cache });
...
var ModelHandlers = (function () {
    ...
    ModelHandlers.prototype.documentReceived = function (conditions, result, wrapper, options) {
        ...
        return Promise.resolve(result).then(function (target) {
            return Promise.resolve().then(function () {
                ...
                if (conditions && _this.model.core.cache && options.cache && !options.fields) {
                ...
                if (_this.model.options.hooks.ready && wrapped instanceof instance)
