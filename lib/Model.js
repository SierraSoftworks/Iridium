...
var Model = (function () {
    ...
    Model.prototype.find = function (conditions, options, callback) {
        ...
        return Promise.resolve().then(function () {
            ...
            return _this.handlers.documentsReceived(conditions, results, _this.helpers.wrapDocument, options);
        }).nodeify(callback);
    };
    ...
    Model.prototype.findOne = function () {
        ...
        return Promise.resolve().bind(this).then(function () {
            ...
            if (!document)
                return null;
            return _this.handlers.documentsReceived(conditions, [document], _this.helpers.wrapDocument, options).then(function (documents) {
                return documents[0];
            });
        }).nodeify(callback);
    };
