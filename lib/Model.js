...
var Model = (function () {
    ...
    Model.prototype.find = function (conditions, fields) {
        ...
        if (!_.isPlainObject(conditions))
            conditions = this._helpers.selectOneDownstream(conditions);
    ...
    Model.prototype.findOne = function () {
        ...
        for (var argI = 0; argI < args.length; argI++) {
            if (typeof args[argI] == 'function')
                ...
                conditions = this._helpers.selectOneDownstream(args[argI]);
        }
        conditions = conditions || {};
        options = options || {};
        _.defaults(options, {
    ...
    Model.prototype.insert = function (objs) {
        ...
        return Promise.resolve().then(function () {
            ...
            if (options.upsert)
                return _this._handlers.creatingDocuments(objects).map(function (object) {
                    return new Promise(function (resolve, reject) {
