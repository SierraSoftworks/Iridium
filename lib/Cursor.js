...
var Cursor = (function () {
    ...
    Cursor.prototype.forEach = function (handler, callback) {
        ...
        return new Bluebird(function (resolve, reject) {
            _this.cursor.forEach(function (item) {
                _this.model.handlers.documentReceived(_this.conditions, item, function () {
                    return helpers.wrapDocument.apply(helpers, arguments);
                }).then(handler);
            }, function (err) {
                if (err)
                    return reject(err);
    ...
    Cursor.prototype.map = function (transform, callback) {
        ...
        return new Bluebird(function (resolve, reject) {
            var promises = [];
            _this.cursor.forEach(function (item) {
                promises.push(_this.model.handlers.documentReceived(_this.conditions, item, function () {
                    return helpers.wrapDocument.apply(helpers, arguments);
                }).then(transform));
            }, function (err) {
                if (err)
    ...
    Cursor.prototype.toArray = function (callback) {
        ...
        return new Bluebird(function (resolve, reject) {
            ...
            return _this.model.handlers.documentReceived(_this.conditions, document, function () {
                return helpers.wrapDocument.apply(helpers, arguments);
            });
        }).nodeify(callback);
    };
