...
var Instance = (function () {
    ...
    Instance.prototype.save = function () {
        ...
        return Promise.resolve().then(function () {
            ...
            return _this._model.handlers.savingDocument(_this, changes);
        }).then(function () {
            ...
            return _this._model.handlers.documentsReceived(conditions, [latest], function (value) {
    ...
    Instance.prototype.refresh = function (callback) {
        ...
        return Promise.resolve().then(function () {
            ...
            return _this._model.handlers.documentsReceived(conditions, [doc], _this._model.helpers.transform.apply, { wrap: false }).then(function (doc) {
        ...
        }).then(function (instances) { return instances[0]; }).nodeify(callback);
    };
    /**
