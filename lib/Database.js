...
Database.prototype.express = function (config) {
	/// <summary>Creates an Express Middleware which will make this database wrapper avaiable through the req.db property</summary>
	/// <param name="config" type="Object">A configuration object, generally loaded from settings.js</param>
	...
	return function (req, res, next) {
		...
		$.connect(config, function (err, _db) {
