 ...
 * property instead.
 */
export declare function MapReduce<Key = any, Value = any, TInstance extends InstanceImplementation<TDocument, TInstance> = any, TDocument = any>(map: MapFunction<TDocument>, reduce: ReduceFunction<Key, Value>): (target: TInstance) => void;
