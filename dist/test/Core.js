...
class InheritedCoreWithHooks extends Iridium.Core {
    constructor() {
        super("mongodb://localhost/test");
        this.onConnectingResult = (connection) => Promise.resolve(connection);
        this.onConnectedResult = () => Promise.resolve();
...
describe("Core", () => {
    describe("constructor", () => {
        ...
        it("should throw an error if no URI or configuration object was provided", () => {
            chai.expect(() => new Iridium.Core(undefined)).to.throw("Expected either a URI or config object to be supplied when initializing Iridium");
        });
